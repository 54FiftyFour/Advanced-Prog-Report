...
<NR>       ::=  "Var" <value> "Assign" <NR> |
    ...
    \end{verbatim}
    \subsection{Commentary}
    Additional patterns are added for variable assignment such that users can either explicitly specify the type of a variable assignment, or let the interpreter infer it. 
	...
	Explicit type declarations are specified with the keywords: \verb|int, float, frac and bool|.
	...
	This is for use in sending plotting functions from the front end to the interpreter.
