% TO DO:CHAPTER 4.3 and 4.4 (architecture and algorithms), CHAPTER 5, CONTRIBUTIONS, PLOTTING NOTES (TAYLOR), FINISH TEST WRITEUP, Section 2  GUI discussion(Taylor), Section 2 simiar systems table (aaron), Section 2 interpreter talk (Aaron)
...
<NR>       ::=  "Var" <value> "Assign" <NR> | "Var" <value> |
    ...
    \subsection{Testing}
    This build passed every test from our unit tests (\ref{ArithTest}, \ref{VarAssignTest} and \ref{PiAbsTest}.)
...
<NR>       ::=  "Var" <value> "Assign" <NR> |
    ...
    \subsection{Testing}
    This build passed every test from our unit tests (\ref{ArithTest}, \ref{VarAssignTest}, \ref{PiAbsTest} and \ref{TypeSysTest}.)
...
<NR>       ::=  "Var" <value> "Assign" <NR> |
    ...
    This build passed every test from our unit tests (\ref{ArithTest}, \ref{VarAssignTest}, \ref{PiAbsTest}, \ref{TypeSysTest} and \ref{FuncAssignTest}) except:
    ...
    \begin{center}
        \begin{tabular}{|p{1.5in}|p{1.5in}|p{1.6in}|p{1.6in}|p{2.4in}|}
            ...
            TEST NAME & INPUT & EXPECTED & RESULT \\
            \hline
            T6.BadAssign3  & "fn foo (x) = 3" & Error & (Ethan, What is the Result??)\\
            \hline
            T6.BadCall2    & "fn foo(x) = x + 3", "foo(3 4)" & 0, Error & (Ethan, What is the Result??)\\
            \hline
        \end{tabular}
    \end{center}

    This Errors are due to parameter passing issues.
...
<NR>       ::=  "!" <NR>
    ...
    \subsection{Testing}
    This build passed every test from our unit tests (\ref{ArithTest}, \ref{VarAssignTest}, \ref{PiAbsTest}, \ref{TypeSysTest}, \ref{FuncAssignTest} and \ref{BoolTest}) except:
...
<NR>       ::=  "!" <NR>
    ...
    \subsection{Testing}
    This build passed every test from our unit tests (\ref{ArithTest}, \ref{VarAssignTest}, \ref{PiAbsTest}, \ref{TypeSysTest}, \ref{FuncAssignTest}, \ref{BoolTest} and \ref{LoopTest}) except:
...
<NR>       ::=  "!" <NR>
    ...
    \subsection{Testing}
    This build passed every test from our unit tests (\ref{ArithTest}, \ref{VarAssignTest}, \ref{PiAbsTest}, \ref{TypeSysTest}, \ref{FuncAssignTest}, \ref{BoolTest}, \ref{LoopTest} and \ref{RatNumTest}) except:
