...
% ============================================================== CHAPTER 2 ===============================================================
    ...
    Therefore its acts similarly to a search engine with a number of functions that you can call to alter its output format. A comparison table of the three systems can be found in Appendix \ref{SSA}. \\

    With an idea of what our system would do and various ideas on how our system would look, we needed an understanding of how we were going to make the system. We have two main components, a GUI and an interpreter, of which is called by the GUI.\\
    With some research, we decided to use Avalonia \citep{Avalonia:2025} and Oxyplot \citep{Oxyplot:2024} for our GUI. \\

    Avalonia is a free open source GUI framework, and is also cross-platform. Avalonia is based on the Windows Presentation Foundation (WPF) \citep{WPF:2023}, so it uses a similar syntax and structure. It uses a Model-View-ViewModel (MVVM) architecture: the View is the part that generates what is visible on screen, stored in .axaml files. The ViewModel is the code behind the View, stored as .axaml.cs files. The Model is essentially a data storage for usage with the application.\newline \newline
    ...
    \begin{itemize}
        ...
        \item Backtracking can occur, potentially creating costly overhead.
    \end{itemize}
...
% % ------------------------------------------------------------- END OF SPRINT ------------------------------------------------------------------
    ...
    Before our final build, we added a number of small features, such as the greater-than-or-equal-to and less-than-or-equal-to operators. Additionally, type-checking for variable assignment was moved to a type as a series of member functions, making our code more maintainable long term.
...
<NR>       ::=  "!" <L>
                "Var" <value> "Assign" <L> |
                "Typ Auto" "Var" <value> "Assign" <L> |
                "Typ Integer" "Var" <value> "Assign" <L> |
                "Typ Float" "Var" <value> "Assign" <L> |
                "Typ Frac" "Var" <value> "Assign" <L> |
                "Typ Bool" "Var" <value> "Assign" <L> |
                "Fn" "Var" <value> "Assign" <L> |
                "Var" <value> |
                "Num Int" <value> | "Num Flt" <value> |
                "Num Bool" <value> | "Frac" "Num Frac" <value> |
                "Sin" <L>  | "Cos" <L> | "Tan" <L> |
                "Asin" <L> | "Acos" <L> | "Atan" <L> |
                "LogNat" <L> | "LogNum" <L> | "Exp" <L> |
                "Pi" | "Abs" <L> |
                "For" "(" "Num Int" <value> ")" "{" <L> "}"
                "(" <L> ")"
    \end{verbatim}
...
%\raggedright
    ...
    \begin{table}[h]
        \begin{tabular}{|l|l|l|l|l|}
            ...
            Percentage Contributed &       25        &        25      &         25      &       25       \\ \hline
        \end{tabular}
    \end{table}
    ...
    I provided work for rational numbers and mathematical functions. I have also contributed to PI and absolute. I have worked on the BNF.
    \subsection{Report Contributions}
    I have contributed heavily to chapter \ref{Chap:background}. I have smaller contributions in chapter \ref{Chap:DevHist}.

    \section{Ethan Colman Contributions}
    Percentage contribution: 25\verb|%|
    \subsection{GUI Contributions}
    I did not contribute to development of the Graphics User Interface.
    \subsection{Interpreter Contributions}
    I contributed development of user defined variables and functions, unit testing and migration of the symbol table to a type.
    \subsection{Report Contributions}
    I contributed to the structure and set up of the report, early versions of sprint commentary, unit tests, the abstract, chapter 1 and chapter 4.
...
% ------------------------------ FINAL GUI TESTS --------------------------------------
    ...
    \begin{tabular}{|p{1.5in}|p{1.5in}|p{1.6in}|p{1.6in}|p{2.4in}|}
        ...
        \hline
        T11.PlotXSquared        & y function = \verb|x^2 |                 & Plot the graph of y = \verb|x^2| for the default interval of 0.1                                      &                                         \\
        \hline
